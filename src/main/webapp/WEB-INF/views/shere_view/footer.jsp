...
<div id="footer">
	<div class="column">
		<h3>Information</h3>
		<ul>
			<li><a href="assets/web/about-us.html">About Us</a></li>
			<li><a href="assets/web/about-us.html">Delivery Information</a></li>
			<li><a href="assets/web/about-us.html">Privacy Policy</a></li>
			<li><a href="assets/web/elements.html">Elements</a></li>
		</ul>
	</div>
	<div class="column">
		<h3>Customer Service</h3>
		<ul>
			<li><a href="assets/web/contact-us.html">Contact Us</a></li>
			<li><a href="assets/web/#">Returns</a></li>
			<li><a href="assets/web/sitemap.html">Site Map</a></li>
		</ul>
	</div>
	<div class="column">
		<h3>Extras</h3>
		<ul>
			<li><a href="assets/web/#">Brands</a></li>
			<li><a href="assets/web/#">Gift Vouchers</a></li>
			<li><a href="assets/web/#">Affiliates</a></li>
			<li><a href="assets/web/#">Specials</a></li>
		</ul>
	</div>
	<div class="column">
		<h3>My Account</h3>
		<ul>
			<li><a href="assets/web/#">My Account</a></li>
			<li><a href="assets/web/#">Order History</a></li>
			<li><a href="assets/web/#">Wish List</a></li>
			<li><a href="assets/web/#">Newsletter</a></li>
		</ul>
	</div>
	<div class="contact">
		<ul>
			...
			<li class="email"><a href="assets/web/mailto:info@demo.com">info@demo.com</a></li>
	...
	<div class="clear"></div>
	<div id="powered">
		Bigshop <a href="assets/web/#">Html Template </a> &copy; 2013 &nbsp;|&nbsp;
