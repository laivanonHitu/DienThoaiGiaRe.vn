		...
		<div id="container">
			...
			<div id="content">
				...
				<form enctype="multipart/form-data" method="post" action="#">
						...
						<table class="form">
							<tbody>
								<tr>
									...
									<td><input class="large-field" type="text" value=""
										name="firstname"></td>
								</tr>
								<tr>
					...
					<div class="content">
						<table class="form">
							<tbody>
								...
								<tr>
									<td><span class="required" id="postcode-required">*</span>
										Post Code:</td>
									<td><input class="large-field" type="text" value=""
										name="postcode"></td>
								</tr>
						...
						<table class="form">
							<tbody>
								<tr>
									...
									<td><input class="large-field" type="password" value=""
										name="password"></td>
								</tr>
								<tr>
							...
							<tbody>
								<tr>
									...
									<td><input type="radio" value="1" name="newsletter">
										Yes <input type="radio" checked="checked" value="0"
										name="newsletter"> No</td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="buttons">
						<div class="right">
							I have read and agree to the <a alt="Privacy Policy"
								href="http://localhost/upload/index.php?route=information/information/info&amp;information_id=3"
								class="colorbox cboxElement"><b>Privacy Policy</b></a> <input
								type="checkbox" value="1" name="agree"> <input
								type="submit" class="button" value="Continue">
						</div>
					</div>
				</form>
			</div>
