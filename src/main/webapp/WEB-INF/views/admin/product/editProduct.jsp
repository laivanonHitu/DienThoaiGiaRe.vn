	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<form:form class="table" modelAttribute="productDetail"
					...
					<table>
						...
						<tr>
							<td>Giá sản phẩm:</td>
							<td><form:input maxlength="10" path="price" /></td>
						</tr>

						<tr>
							<td>Giá khuyễn mại:</td>
							<td><form:input maxlength="10" path="priceDis" /></td>
						</tr>
					...
					<tr>
						...
						<tr>
							<td>Mô tả dài:</td>
							<td><form:textarea id="editor1" path="shortDecription" /></td>
						</tr>
